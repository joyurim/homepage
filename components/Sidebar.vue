<template>
  <nav class="nav">
    ...
    >
      ...
      <ul class="mt-3">
        <li
          v-for="gnb in nav.gnbList"
          :key="`sidebar-gnb-${gnb.menuId}`"
          class="nav__list"
        >
          <nuxt-link :to="gnb.menuUrl" class="nav__list--menu">{{
            gnb.menuNm
          }}</nuxt-link>
        </li>
      </ul>
